...
describe('render.js', () => {
  ...
  describe('renderSkeletonCards', () => {
    test('should return correct number of skeletons', () => {
      const html = renderSkeletonCards(6);
      const skeletons = (html.match(/skeleton-card/g) || []).length;
  ...
  describe('renderEmptyState', () => {
    ...
    test('should contain the provided message', () => {
      const html = renderEmptyState('No results found', ['Try searching again']);
  ...
  describe('renderErrorToast', () => {
    ...
    test('should add error type by default', () => {
      renderErrorToast('Error message', 'error');
  ...
  describe('renderPagination', () => {
    test('should create pagination container', () => {
      const callback = jest.fn();
      const result = renderPagination(1, 5, callback);
      
      expect(result).toBeTruthy();
    });

    test('should include pagination buttons', () => {
      const callback = jest.fn();
      const result = renderPagination(1, 3, callback);
      
      expect(result.innerHTML).toContain('page-btn');
    });
  });
});
